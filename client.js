(function (global, factory) {
    ...
    var _class = function () {
        ...
        _createClass(_class, null, [{
            ...
            key: 'signin',
            value: function () {
                var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(rawParams) {
                    var _this2 = this;

                    var reCaptchaToken, isParamsString, params, rest, formData, route, encodedForm;
                        ...
                        while (1) {
                            switch (_context6.prev = _context6.next) {
                                case 0:
                                    ...
                                    reCaptchaToken = null;
                                    isParamsString = typeof rawParams === 'string';
                                    params = isParamsString ? rawParams : {};

                                    if (!isParamsString) {
                                        reCaptchaToken = rawParams.reCaptchaToken;
                                        rest = {};

                                        Object.keys(rawParams).filter(function (k) {
                                            return k !== 'reCaptchaToken';
                                        }).forEach(function (k) {
                                            rest[k] = rawParams[k];
                                        });
                                        params = rest;
                                        if (Object.keys(rest).length === 1 && rest.email) {
                                            params = rest.email;
                                        }
                                    }
